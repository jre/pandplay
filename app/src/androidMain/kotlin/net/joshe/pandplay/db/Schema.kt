...
interface MusicDao {
    ...
    suspend fun getStationSongListened(id: String):
            Map<@MapColumn("songIdentity") SongId, @MapColumn("lastListened") Long>

    @Query("SELECT songIdentity, added FROM station_songs WHERE stationId = :id")
    suspend fun getStationSongAdded(id: String):
            Map<@MapColumn("songIdentity") SongId, @MapColumn("added") Long>
}
